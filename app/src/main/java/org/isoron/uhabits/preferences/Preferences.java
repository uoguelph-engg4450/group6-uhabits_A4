    ...
    implements SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    //sorted stuff
    public boolean getShowSorted()
    {
        return prefs.getBoolean("pref_show_sorted", true);
    }

    public void setShowSorted(boolean showSorted)
    {
        prefs.edit().putBoolean("pref_show_sorted", showSorted).apply();
    }
